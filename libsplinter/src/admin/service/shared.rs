...
impl AdminServiceShared {
        ...
        match header.get_action() {
            ...
            CircuitManagementPayload_Action::CIRCUIT_PROPOSAL_VOTE => {
                ...
                let vote_record = VoteRecordBuilder::new()
                    ...
                    .build()
                    .expect("Unabel to build vote record");
                ...
                circuit_proposal = circuit_proposal
                    ...
                    .with_votes(&votes)
                    .build()
                    .expect("Unable to build new circuit_propsoal");
    ...
    pub fn add_proposal(
        ...
        // TODO remove expect
        Ok(self.admin_store.add_proposal(
            StoreProposal::from_proto(circuit_proposal).expect("Unable to convert"),
        )?)
    }
